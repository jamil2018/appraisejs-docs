...
> Beginners: start with [Creating Tests](/getting-started/creating-tests/) or [Locators](/build-tests/locators/) if you still need the workflow context. This page is the exact input-step reference.

Source: `src/tests/steps/actions/input.step.ts`.

See shared placeholder rules in [Step Parameter Conventions](/reference/step-references/step-parameter-conventions).
...
- [Storage Steps](/reference/step-references/storage-steps/)
- [Random Data Steps](/reference/step-references/random-data-steps/)
