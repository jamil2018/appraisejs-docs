...
> Beginners: start with [Locators](/build-tests/locators/) if you still need the UI-element workflow first. This page is the exact hover-step reference.
...
- [Click Steps](/reference/step-references/click-steps/)
