...
> Beginners: start with [Running Tests](/getting-started/running-tests/) if you are still learning when waits are necessary. This page is the exact synchronization-step reference.
