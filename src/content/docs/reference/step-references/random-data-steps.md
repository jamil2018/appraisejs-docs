...
> Beginners: start with [Template Steps](/build-tests/template-steps/) if you still need the authoring context first. This page is the exact random-data reference.
