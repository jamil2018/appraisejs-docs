...
> Beginners: start with [Creating Tests](/getting-started/creating-tests/) or [Template Steps](/build-tests/template-steps/) if you need the authoring workflow first. This page is the exact click-step reference.
...
- [Hover Steps](/reference/step-references/hover-steps/)
- [Input Steps](/reference/step-references/input-steps/)
