...
Create-AppraiseJS allows you to create a new AppraiseJS project with a bundled template and get you started with a running local app without having to endure the pain of setting up a new project from scratch.
